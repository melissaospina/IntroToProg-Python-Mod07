...
#   MelissaGO,3/10/2026,Created Script
# ------------------------------------------------------------------------------------------ #
import json
import _io
...
class Person:
    ...
    ChangeLog:
    MelissaGO, 3/10/2026, Created the class.
    """
...
class FileProcessor:
    ...
    MelissaGO,3/10/2026 , Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        MelissaGO, 3/10/2026,Created function
        """
        file = None
        ...
        try:
            ...
            for row in json_students:
                student_object = Student (first_name=row["FirstName"],
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            if not student_first_name.isalpha():
                raise ValueError("The last name can only contain letters.")
            ...
            IO.output_error_messages(messsage="One of the values was the correct type of data!", error=e)
        except Exception as e:
